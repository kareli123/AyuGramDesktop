...
public:
	...
	[[nodiscard]] bool windowGlassBackdrop() const { return _windowGlassBackdrop.current(); }
	...
	void setWindowGlassBackdrop(bool val);
	...
	[[nodiscard]] rpl::producer<bool> windowGlassBackdropValue() const { return _windowGlassBackdrop.value(); }
	[[nodiscard]] rpl::producer<bool> windowGlassBackdropChanges() const { return _windowGlassBackdrop.changes(); }
...
private:
	...
	rpl::variable<bool> _windowGlassBackdrop = false;
